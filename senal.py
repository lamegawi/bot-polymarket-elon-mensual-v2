...
# -*- coding: utf-8 -*-
"""
MOTOR DE SEÑAL — ventana MENSUAL «Elon Musk # tweets in <mes> <año>?»
======================================================================
Reglas R1–R7 adaptadas a la ventana MENSUAL (mes natural, bins de 20
...
de VENTAJA RELATIVA (p_modelo ≥ precio + 10pp) porque las p_modelo
realistas en los bins centrales son 25-50% con cuotas 7-20 (la regla
absoluta p ≥ 60% de las ventanas de 48 h nunca dispararía aquí).

  R7  Progresión 2.00 × 1.35^(paso−1), reinicio a 2.00 tras ganar,
      máx. 5 pasos (pérdida máx. de ciclo ≈ $19.94).
"""
import argparse
import csv
import math
...
# ----------------------------------------------------------------------------
VENTANA        = "mensual"     # 48h | semanal | mensual
STAKE_INICIAL  = 2.00          # $, primera apuesta de cada ciclo
FACTOR         = 1.38          # multiplicador tras cada fallo (V2: óptimo para cuota 3.00)
...
PASOS_MAX      = 5             # stop-loss del ciclo (paso máximo)
REGLA          = "ventaja"     # "absoluta" (48h) | "ventaja" (semanal/mensual)
EDGE_MIN       = 0.10          # ventaja mínima p_modelo − precio (10 pp)
